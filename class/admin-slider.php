...
/**
 * Gérer la fonctionnalité de la zone d'administration
 *
 * @author Adama
 */
    ...
    class adminSlider {
        ...
        public function addSlider(){ 
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <a class="btn btn-info" href="<?php echo $slider_display_url; ?>"><i class="fa fa-home" ></i>&nbsp;SLIDER ESGI</a>
                    </div>
                </div>
                <div class="mt-2"></div>    
                ...
                <div class="panel-group" id="accordion">
                          ...
                          <div class="panel-body">
                            ...
                            <div class="row">  
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <small class="form-text text-muted font-italic">Laisser vide. Si vous définissez la largeur, cela peut être<span class="text-danger text-capitalize"> affecté dans la conception responsive</span>. Par défaut, prenez la hauteur de l'élément parent</small>
                                </div>
                            </div>  
                            <div class="row">
                                <div class="form-group col-md-3">
                                    <label for="spaceBetween">Espacement</label>
                                    <div class="input-group mb-2">
                                    ...
                                    <small class="form-text text-muted font-italic">Distance entre slides</small>
                                </div>
                                <div class="form-group col-md-3">
                                    ...
                                    <small id="emailHelp" class="form-text text-muted font-italic">Durée de transition entre slides (<span class="font-weight-bold text-success">en ms</span>)</small>
                                </div>
                                <div class="form-group col-md-3">
                                   ...
                                   <small class="form-text text-muted ">Default <span class="font-weight-bold text-success">True</span><br>(<span class="font-italic">Définir sur true pour activer le mode boucle continue</span>)</small>
                                </div>
                                 <div class="form-group col-md-3">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading card-header text-center">
                           <h4 class="panel-title">
                               <a data-toggle="collapse" data-parent="#accordion" href="#collapse2"><i class="fa fa-camera-retro" aria-hidden="true"></i>&nbsp;Ajouter Slide</a>
                           </h4>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading card-header text-center">
                           <h4 class="panel-title">
                               <a data-toggle="collapse" data-parent="#accordion" href="#collapse4"><i class="fa fa-newspaper" aria-hidden="true"></i>&nbsp;Aperçu Slider</a>
                           </h4>
                        </div>
                               ...
                               <div class="row mt-5">
                                ...
                                <div class="row mt-3"> 
                                    <div class="col-12">
                                        ...
                                        <div class="text-center">
                                            <button type="button" class="btn btn-outline-primary shortcode-preview" data-post_id="<?php echo $post_id ?>"><i class="fa fa-newspaper"></i> Aperçu</button>
                                        </div>
                                    </div>
                                </div>
                               <div class="mb-5"></div>
                       ...
                       <div id="collapse3" class="panel-collapse collapse">
                            <div class="panel-body">
                                ...
                                <div class="row mt-5">
                                    <div class="col-6">
                                        <div class="text-center">
                                            <button class="btn btn-success" id="slider-submit" type="submit">Enregistrer Slider</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-5">
        ...
        public function displayShortcodeList(){ 
            ...
            <div class="container">
                ...
                <div class="row mt-5">
                    <div class="col-2">
                        <a class="btn btn-success" href="<?php echo $add_slide_url; ?>"><i class="fa fa-plus" ></i>&nbsp;Nouveau Slider</a>
                    </div>
                                    ...
                                    if($the_query->have_posts() ) : 
                                        while ( $the_query->have_posts() ) :
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-info" href="<?php echo $add_slide_url."&id=$post_id";?>"><i class="fa fa-pencil-alt" aria-hidden="true"></i> Modifier</a>
                                                    <div class="mt-1"></div>
                                                    <button class="btn btn-danger delete-shortcode" data-post_id="<?php echo $post_id ?>"><i class="fa fa-trash"></i> Supprimer</button>
                                                </td>
                                            </tr>
                                        <?php
                                        endwhile;
        ...
        public function slider_delete(){
            ...
            wp_die(); // cela est nécessaire pour terminer immédiatement et renvoyer une réponse appropriée
        }
        ...
        public function slider_preview() { 
            ...
            <div class="text-center text-primary">
                <h4>Aperçu Slider</h4>
                <button type="button" class="btn btn-danger btn-denger m-0 mb-1 mt-1 preview-close"><i class="fa fa-times"></i>&nbsp;Fermer</button>
            </div>
        ...
        public function add_html_in_footer() { ?>
            ...
            <div class="wsd-shortcode-insert" id="wsd-shortcode-insert">
                <div class="wsd-title">
                    <h3>Sélectionnez le diaporama à insérer dans la publication<span id="wsd-shortcode-popup-close">X</span></h3>
                </div><hr>
                            ...
                            $args = array(
                                ...
                                if($the_query->have_posts() ) { ?>
                                    <div class="wsd-slider-select">
                                        <label class="post-attributes-label" for="start_of_week">Nom Slider</label>
